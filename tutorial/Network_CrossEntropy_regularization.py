...
class Network(object):
	...
	def backprop(self, x, y):
        ...
        # backward pass
		delta = self.cost_derivative(activations[-1], y)   #this is differet from that in previous file
		nabla_b[-1] = delta
...
#net.SGD(training_data[:1000], 400, 10, 0.5, test_data=test_data, lmbda = 0.1)
net.SGD(training_data, 30, 10, 0.5, test_data=test_data,  lmbda = 5)
